...
async function submitDriftScore(playerName, playerScore) {
    // 1. Ensure the user is actually logged in
        if (!window.auth || !window.auth.currentUser) {
                console.log("Guest player. Score not saved to live leaderboard.");
                        return; 
                            }
                                                                ...
                                                                const docRef = window.doc(window.db, "DriftScores", userEmail);
                                                                        const docSnap = await window.getDoc(docRef);
                                                                                        ...
                                                                                        let cumulativeScore = playerScore;
                                                                                                        ...
                                                                                                        // 3. Cumulative Logic: If they have played before, add the new score to their old score
                                                                                                                if (docSnap.exists()) {
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        console.log(`Saved! New Total for ${displayName}: ${cumulativeScore}`);
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    console.error("Failed to save cumulative score: ", error);
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        async function fetchDriftLeaderboard() {
                                                                                                                                                                                                                                            const leaderboardList = document.getElementById("leaderboard-list");
                                                                                                                                                                                                                                                if (leaderboardList) leaderboardList.innerHTML = `<div style="text-align: center; color: white; font-family: monospace;">Fetching Live Scores...</div>`;
                                                                                                                                                                                                                                                    
                                                                                                                                                                                                                                                        try {
                                                                                                                                                                                                                                                                // 5. Query the database: Sort by highest score, and ONLY grab the Top 10
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        dataArray.push(docSnap.data());
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                renderDriftLeaderboardUI(dataArray);
                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                            console.error("Failed to fetch leaderboard: ", error);
                                                                                                                                                                                                                                                                                                                                                                                                                    if (leaderboardList) leaderboardList.innerHTML = `<div style="text-align: center; color: red;">Network Error.</div>`;
                                                                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                                                                                        }
