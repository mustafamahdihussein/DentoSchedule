...
// ==========================================
                                                                                                                                                                                                                                                                                                                                                  async function submitDriftScore(playerName, playerScore) {
                                                                                                                                                                                                                                                                                                                                                        // 1. Ensure the user has a valid Firebase session (Admin or Anonymous)
                                                                                                                                                                                                                                                                                                                                                            if (!window.auth || !window.auth.currentUser) {
                                                                                                                                                                                                                                                                                                                                                                    console.log("No Firebase session found. Score not saved.");
                                                                                                                                                                                                                                                                                                                                                                            return; 
                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    const user = window.auth.currentUser;
                                                                                                                                                                                                                                                                                                                                                                                        let displayName = "Student";
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                // 2. Safely determine the display name
                                                                                                                                                                                                                                                                                                                                                                                                    if (user.email) {
                                                                                                                                                                                                                                                                                                                                                                                                            // If it's the Admin, use the first part of their email
                                                                                                                                                                                                                                                                                                                                                                                                                    displayName = user.email.split('@')[0]; 
                                                                                                                                                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                // If it's an anonymous student, grab the name they typed at login, or use the game prompt
                                                                                                                                                                                                                                                                                                                                                                                                                                        displayName = localStorage.getItem("username") || playerName || "Driver_" + user.uid.substring(0, 4);
                                                                                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                                                                                                
                                                                                                                                                                                                                                                                                                                                                                                                                                                    try {
                                                                                                                                                                                                                                                                                                                                                                                                                                                            // 3. Use their unique Firebase UID as the document ID instead of an email
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    const docRef = window.doc(window.db, "DriftScores", user.uid);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            const docSnap = await window.getDoc(docRef);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            let cumulativeScore = playerScore;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            // 4. Cumulative Logic: Add new score to old score if they played before
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    if (docSnap.exists()) {
